...
class StoragePage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.storage_segunda_tela)
        ...
        val botaoperfil: Button = findViewById(R.id.PerfilButton)
        botaoperfil.setOnClickListener {
            val intent = Intent(this, PerfilActivity::class.java)
            startActivity(intent)
        }

        val botaowebview: Button = findViewById(R.id.WebViewButton)
        botaowebview.setOnClickListener {
